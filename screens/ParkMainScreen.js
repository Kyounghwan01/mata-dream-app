      ...
      <View>
        <View>
          ...
          <View>
            ...
            <View>
              <Text>
                1.자리를 등록 하시고 판매를 원하시는 분들은 mataDream 페이지의
                오른쪽 하단 등록버튼(+)을 클릭하시면 됩니다. 중복 판매 방지를
                위해 한번 등록하시면 위 아이콘은 없어지고 삭제 버튼(-)으로
                바뀝니다.
              </Text>
              <Text>
                1-1. 등록버튼 클릭시 마커를 클릭하시고 현재 위치를 지정하시고,
                현재 보이시는 뷰를 사진으로 찍어 등록하신 후, 포인트를
                지정하시면 됩니다.
              </Text>
              <Text>
                1-2. 삭제 버튼(-)을 클릭하시면 등록하신 내역은 사라지고 자동으로
                등록 버튼(+)으로 바뀝니다.
              </Text>
            </View>
            <View>
              <Text>
                2. 이용을 원하시는 분은 지도, 사진을 통해 위치를 확인하시고
            ...
            <View>
              <Text>
                ...
                판매자, 구매자 모두 클릭하시면 포인트가 이동하고, 거래 방 및
                주문 리스트는 자동으로 삭제됩니다.
              </Text>
              <Text>
                3-1. 거래 도중 다른 판매자와 거래 하실 수 없습니다. 거래를
                변경하시려면 나가기 버튼을 누르시면 자동으로 현재 거래가
                취소됩니다.
              </Text>
            </View>
            <View>
